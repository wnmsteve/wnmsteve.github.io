    ...
    link = {
        ...
        comm: {
            ...
            polygonSAT: function(e, t, n, r, i, s, o, u) {
                var a = e.length, f = t.length, l = n || 0, c = r || 0, h = i || 0, p = s || 0, d = o, v = u, m = l + e[e.length - 1][0], g = c + e[e.length - 1][1], y, b, w, E, S, x, T, N, C, k, L;
                for (k = 0; k < a; k++) {
                    y = l + e[k][0],
                    b = c + e[k][1],
                    w = b - g,
        ...
        clearAsyncImageCache: function() {
            try {
                var e = n.image.imgs, t, r;
                for (var i in e)
                    t = e[i],
                    t && (r = n.image.asyncImgObjs[i],
                    r && (r.inited = !1,
                    this.delImage(i).canvas.del(i)));
                e = t = r = null
            } catch (s) {}
            return this
        },
        ...
        buttonLayout: {
            ...
            destroy: function(e) {
                var t = n.buttonLayout.buttons, r;
    ...
    return {
        init: function() {
            ...
            e.run(function() {
                ...
                e.buttonLayout.released("difficulty1") ? (l.moduleName = "普通模式",
            ...
            var l = {
                ...
                Scene: e.extend(function(t) {
                    ...
                    touchStart: function(t, n) {
                        return this.host.endPath() ? (e.comm.collision(t, n, 1, 1, this.x, this.baseY - this.height, this.width, this.height) && this.host.setPath([[0, -20], [0, -20], [0, -20], [0, -10], [0, -10], [0, -10], [0, -5], [0, -5], [0, -5], [0, 5], [0, 5], [0, 5], [0, 10], [0, 10], [0, 10], [0, 20], [0, 20], [0, 20]]),
                        this) : this
                    }
                })
            }
